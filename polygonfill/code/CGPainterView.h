...
public:
	...
	void Scan_line_Fill(CDC *pDC, COLORREF fillCol, COLORREF interiorCol);
	void BoundaryFill_Scan( CDC *pDC, CPoint startPoint, COLORREF fillCol, COLORREF boundaryCol );
